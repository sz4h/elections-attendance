    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.voters.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('circuit_no') ? 'is-invalid' : '' }}" type="number" name="circuit_no" id="circuit_no" value="{{ old('circuit_no', '5') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parlmaint_no') ? 'is-invalid' : '' }}" type="number" name="parlmaint_no" id="parlmaint_no" value="{{ old('parlmaint_no', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parlmaint_name') ? 'is-invalid' : '' }}" type="text" name="parlmaint_name" id="parlmaint_name" value="{{ old('parlmaint_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parlmaint_type') ? 'is-invalid' : '' }}" type="number" name="parlmaint_type" id="parlmaint_type" value="{{ old('parlmaint_type', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('letter') ? 'is-invalid' : '' }}" name="letter_id" id="letter_id" required>
                    @foreach($letters as $id => $entry)
                        <option value="{{ $id }}" {{ old('letter_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('register_number') ? 'is-invalid' : '' }}" type="number" name="register_number" id="register_number" value="{{ old('register_number', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('register_date') ? 'is-invalid' : '' }}" type="text" name="register_date" id="register_date" value="{{ old('register_date') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('moi_reference') ? 'is-invalid' : '' }}" type="number" name="moi_reference" id="moi_reference" value="{{ old('moi_reference', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('register_status') ? 'is-invalid' : '' }}" type="text" name="register_status" id="register_status" value="{{ old('register_status', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('attended') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="attended" id="attended" value="1" {{ old('attended', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('targeted') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="targeted" id="targeted" value="1" {{ old('targeted', 0) == 1 ? 'checked' : '' }}>
